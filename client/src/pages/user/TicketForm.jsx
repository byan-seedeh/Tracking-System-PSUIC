// client/src/pages/user/TicketForm.jsx
            ...
            <div className="bg-[#193C6C] px-6 pt-10 pb-12 rounded-b-[3rem] shadow-lg relative z-0 overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto flex items-center justify-between relative z-10">
                    <div className="flex items-center gap-4">
                        ...
                        <h1 className="text-3xl font-semibold tracking-tight text-white leading-tight">Report Issue</h1>
                    </div>
                </div>
            </div>

            <div className="max-w-4xl mx-auto mt-6 px-6 space-y-8 relative z-10 pb-20">
