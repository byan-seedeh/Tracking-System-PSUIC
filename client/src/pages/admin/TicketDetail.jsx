        ...
        <div className="space-y-6">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col gap-1">
                <div className="flex items-center gap-4">
                    ...
                    <h1 className="text-3xl font-semibold text-[#193C6C] tracking-tight font-poppins">Ticket #TK-{String(ticket.id).padStart(2, '0')}</h1>
                </div>
                <p className="text-gray-500 text-sm font-medium font-poppins ml-14">
                    Created on {dayjs(ticket.createdAt).format('MMMM D, YYYY')}
                </p>
            </div>
