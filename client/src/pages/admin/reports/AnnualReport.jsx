...
const AnnualReport = () => {
    ...
    const [isYearOpen, setIsYearOpen] = useState(false); // [NEW]
                ...
                <div className="flex items-center gap-2 bg-gray-50 px-3 py-2 rounded-xl border border-gray-100">
                    <div className="relative">
                        <button
                            ...
                            className="flex items-center gap-2 bg-transparent text-sm font-semibold text-gray-700 focus:outline-none"
                        >
                            <span>{year}</span>
                        ...
                        {isYearOpen && (
                            <div className="absolute top-full left-0 mt-2 bg-white border border-gray-100 rounded-xl shadow-xl z-20 overflow-hidden animate-in fade-in zoom-in-95 duration-200 min-w-[100px]">
                                {[2024, 2025, 2026].map(y => (
                                    <button
                                        ...
                                        className="w-full text-left px-4 py-2 text-sm font-medium text-gray-700 hover:bg-[#F6F6F6] transition-colors"
                                    >
                                        {y}
                                    </button>
                                ))}
